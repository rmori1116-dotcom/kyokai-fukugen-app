# ソース一式（境界復元支援アプリ v0.5）

> 現在のアプリ版は **v0.5** です。v0.5では杭種名をアルミプレート・ペンキへ更新し、SIMA順の10列CSV出力を追加しました。
...
現在のテストは、杭種略称、10列CSVの内容・SIMA順・実ダウンロード、選点版との保存領域分離、スマホ縦390×844のタッチ領域検証を含む326項目です。
